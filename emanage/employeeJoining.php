...
<div class="container my-md-5">
    ...
    " action="employeeJoiningCheck.php" method="POST">
        ...
        <h2 class="text-center text-primary fw-bold">Salary Entry</h2>
        <div class="row mb-3">
            <label for="inputEmail3" class="col-sm-3 col-form-label text-light">Employee Name</label>
            <div class="col-sm-8">
                <select name="name" name="employee_id" class="form-select col-sm-8" aria-label="Default select example">
                    <?php
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <select name="designation" name="designation_id" class="form-select col-sm-8"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-8">
                <select name="designation" name="department" class="form-select col-sm-8"
                    aria-label="Default select example">
                    <?php
                    $sql = "SELECT * FROM designation";
                    $result = $conn->query($sql);
